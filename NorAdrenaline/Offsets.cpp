...
DWORD COffsets::PlayVoiceFiles()
{
	DWORD Address = FindPattern("", "xxxxxxx????xx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxx????x????xx????xxxxx????????x????xx????xxxxxxxxx????x????xxxx????xx????????xx????xxxxxxxx????x????xxxx????", hardware.base, hardware.end, 0);

	if (FarProc(Address, hardware.base, hardware.end))
		Error("PlayVoiceFiles not found");
